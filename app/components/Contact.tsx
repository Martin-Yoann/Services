      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#09233f] mb-4">Get In Touch</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {/* Contact Info Cards */}
            <div className="p-6 bg-white rounded-lg border border-[#d8e1ea] text-center hover:border-[#0e8a9a] transition-colors">
              <div className="text-3xl mb-3">✉️</div>
              <h3 className="font-bold text-[#09233f] mb-2">Email</h3>
              <a
                href="mailto:echo.yang@happyglobalservice.com"
                className="text-[#0e8a9a] hover:underline text-sm"
              >
            ...
            <div className="p-6 bg-white rounded-lg border border-[#d8e1ea] text-center hover:border-[#0e8a9a] transition-colors">
              ...
              <h3 className="font-bold text-[#09233f] mb-2">Phone</h3>
              <a href="tel:+16698713588" className="text-[#0e8a9a] hover:underline text-sm">
                +1 669 871 3588
              </a>
            </div>
            <div className="p-6 bg-white rounded-lg border border-[#d8e1ea] text-center hover:border-[#0e8a9a] transition-colors">
              <div className="text-3xl mb-3">🌐</div>
              <h3 className="font-bold text-[#09233f] mb-2">Inquiry Types</h3>
          ...
          <div className="bg-white rounded-lg border border-[#d8e1ea] p-8 md:p-12 shadow-sm">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-2xl font-bold text-[#09233f] mb-2">Thank you!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-bold text-[#09233f] mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 border border-[#d8e1ea] rounded-lg focus:outline-none focus:border-[#0e8a9a] focus:ring-2 focus:ring-[#0e8a9a]/20 transition-all"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-bold text-[#09233f] mb-2">
                      Work Email *
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="company" className="block text-sm font-bold text-[#09233f] mb-2">
                      Company *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-bold text-[#09233f] mb-2">
                      Phone (optional)
                    </label>
                    <input
                      type="tel"
                ...
                <div>
                  <label htmlFor="inquiryType" className="block text-sm font-bold text-[#09233f] mb-2">
                    Inquiry Type *
                  </label>
                  <select
                    id="inquiryType"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-bold text-[#09233f] mb-2">
                    Message *
                  </label>
                  <textarea
                    id="message"
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-[#d8e1ea] rounded-lg focus:outline-none focus:border-[#0e8a9a] focus:ring-2 focus:ring-[#0e8a9a]/20 transition-all resize-none"
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-[#0e8a9a] hover:bg-[#0b7280] text-white font-bold py-3 px-8 rounded-lg transition-all hover:shadow-lg hover:shadow-[#0e8a9a]/30"
                >
                  Send Message
                </button>
              </form>
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              <details key={faq.q} className="group rounded-xl border border-[#d8e1ea] p-5 transition-all duration-300 hover:border-[#0e8a9a]/30 cursor-pointer">
