        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col justify-center">
            ...
            >
              ...
              international markets — helping companies find, hire, and retain the
            ...
            {themes.map((theme, index) => {
              ...
              return (
                <button
                  ...
                  className={`group relative text-left w-full rounded-2xl p-5 lg:p-6 transition-all duration-300 cursor-pointer
