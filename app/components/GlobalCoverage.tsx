...
const regions = [
  { name: "North America", stats: "250+ placements/yr", desc: "Headquarters and largest market. Deep networks across Texas, California, and the Midwest.", cities: [{ n: "Dallas, TX", t: "HQ" }, { n: "San Jose, CA", t: "Tech" }, { n: "Los Angeles, CA", t: "Consumer" }, { n: "Seattle, WA", t: "Tech" }, { n: "Chicago, IL", t: "Industrial" }], accent: "#5dadec", accentRgb: "93,173,236" },
  ...
  return (
    <>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden" style={{ background: "#060e18" }}>
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-[140px] opacity-[0.04] pointer-events-none" style={{ background: "#0e8a9a", transform: "translate(-30%, 30%)" }} />
        ...
        <div className="relative container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white hg-heading tracking-tight mb-4">Connected across <span style={{ color: "#5dadec" }}>three continents</span></h2>
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 text-sm font-bold text-[#5dadec] hover:gap-3 transition-all">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[{ v: "430+", l: "Placements/yr", c: "#5dadec" }, { v: "13", l: "Cities", c: "#14b8a6" }, { v: "3", l: "Continents", c: "#f59e0b" }, { v: "5+", l: "Languages", c: "#a855f7" }].map((s) => (
