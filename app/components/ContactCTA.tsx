    ...
    <>
      ...
      {modalOpen && (
        ...
        >
          ...
          {/* Modal card */}
          <div
            className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl p-6 md:p-8 transition-all duration-300"
            style={{
          ...
          >
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 w-8 h-8 rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors cursor-pointer"
              aria-label="Close"
            >
              <svg
                width="16"
            ...
            {submitted ? (
              ...
              <>
                <div className="mb-6">
                  <span
                    className="inline-block text-[11px] font-bold uppercase tracking-[0.2em] mb-2 px-3 py-1 rounded-full text-xs"
                    style={{
                      color: "#D96C57",
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all resize-none text-sm"
                      style={{
                        borderColor: "var(--hg-color-border)",
                        background: "var(--hg-color-bg)",
                      }}
                  ...
                  <button
                    type="submit"
                    className="w-full font-bold py-3 rounded-lg text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hg-gradient-coral cursor-pointer"
                    style={{
