...
export default function ExecutiveSearchPage() {
  return (
    <>
      <PageHeader title="Executive Search" accentColor="#D96C57" subtitle="Strategic leadership hiring for C-suite, VP, and Director-level roles across U.S., China, and global markets." breadcrumb={[{ label: "Home", href: "/" }, { label: "Services", href: "/services" }, { label: "Executive Search", href: "/services/executive-search" }]} />
      ...
      <section className="relative py-20 md:py-28 overflow-hidden" style={{ background: "linear-gradient(180deg, #fff 0%, var(--hg-color-bg) 100%)" }}>
        ...
        <div className="relative container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block text-[11px] font-bold uppercase tracking-[0.2em] mb-4 px-4 py-1.5 rounded-full" style={{ color: "#D96C57", background: "rgba(217,108,87,0.06)", border: "1px solid rgba(217,108,87,0.1)" }}>C-Suite & Leadership</span>
            ...
            <div className="grid grid-cols-1 gap-4">
              {[{ v: "500+", l: "Executive Placements", c: "#D96C57" }, { v: "30d", l: "Avg. Time-to-Hire", c: "#14b8a6" }, { v: "95%", l: "Retention Rate", c: "#f59e0b" }].map((s) => (
      ...
      <section className="relative py-20 md:py-28 overflow-hidden" style={{ background: "#060e18" }}>
        ...
        <div className="absolute top-0 right-0 w-[400px] h-[400px] rounded-full blur-[140px] opacity-[0.04] pointer-events-none" style={{ background: "#D96C57", transform: "translate(30%, -30%)" }} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 max-w-5xl mx-auto">
            {processSteps.map((p) => (
              <div key={p.step} className="group rounded-2xl p-6 transition-all duration-500 hover:-translate-y-2"
                ...
                <p className="text-3xl font-bold hg-heading mb-3 text-[#D96C57] group-hover:scale-110 transition-transform duration-500 origin-left">{p.step}</p>
      ...
      <section className="relative py-20 overflow-hidden" style={{ background: "#060e18" }}>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full blur-[160px] opacity-[0.05] pointer-events-none" style={{ background: "#D96C57" }} />
        <div className="relative container mx-auto px-6 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 font-bold px-10 py-4 rounded-xl text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group"
            style={{ background: "linear-gradient(135deg, #D96C57, #2d8a7a)", boxShadow: "0 4px 24px rgba(45,138,122,0.35)" }}>
